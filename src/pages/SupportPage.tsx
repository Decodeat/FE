  ...
  return (
    <div className="space-y-8">
      ...
      <section className="w-full bg-[#D2EDE4] py-20 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-[#2D5945] mb-2">문의하기</h2>
      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
          <div className="bg-white rounded-xl p-5 border border-gray-200">
            ...
            <p className="mt-2 text-sm text-gray-600">답변은 영업일 기준 24시간 내에 발송됩니다.</p>
            <a
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200">
            ...
            <p className="mt-2 text-sm text-gray-600">자주 묻는 질문에서 빠르게 해결하세요.</p>
            <a href="#faq" className="mt-3 inline-block text-emerald-600 hover:underline">
              FAQ 바로가기
            </a>
          </div>
          <div className="bg-white rounded-xl p-5 border border-gray-200">
            ...
            <p className="mt-2 text-sm text-gray-600">제품 등록과 분석 과정 가이드를 확인하세요.</p>
            <a href="/onboarding" className="mt-3 inline-block text-emerald-600 hover:underline">
              시작 가이드
            </a>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl p-6 border border-gray-200 mt-5">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">문의 유형</label>
              <select
                value={type}
        ...
        {/* FAQ */}
        <section id="faq" className="bg-white rounded-xl p-6 border border-gray-200 mt-5">
          ...
          <div className="divide-y divide-gray-200">
            <details className="py-3 group">
              ...
              <p className="mt-2 text-sm text-gray-600">
                제품 등록 페이지에서 사진을 첨부하신 뒤 안내에 따라 업로드하면 됩니다.
              </p>
            </details>
            <details className="py-3 group">
              <summary className="cursor-pointer font-medium flex items-center justify-between">
              ...
              <p className="mt-2 text-sm text-gray-600">
                일반적으로 수 분 내에 완료되며, 마이페이지에서 진행 상황을 확인할 수 있습니다.
              </p>
            </details>
            <details className="py-3 group">
              <summary className="cursor-pointer font-medium flex items-center justify-between">
