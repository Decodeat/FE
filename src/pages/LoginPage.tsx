...
const DecodEatLoginPage: React.FC = () => {
  ...
  const handleKakaoLogin = () => {
    ...
    window.location.href = "http://api.decodeat.store/oauth2/authorization/kakao";
  };
        ...
        <div className="w-full max-w-lg">
          <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
            ...
            <button
              ...
              className="w-full bg-[#FEE500] hover:bg-[#FEE500]/90 text-black font-medium py-5 px-8 rounded-xl flex items-center justify-center space-x-3 transition-colors duration-200 shadow-sm hover:shadow-md cursor-pointer"
              style={{
