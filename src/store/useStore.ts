...
export const useFilterStore = create<FilterState>()((set, get) => ({
  ...
  checkedItems: {
    ...
    "soluble-dietary-fibers": false,
    "insoluble-dietary-fibers": false,
    allergens: false,
    additives: false,
    others: false,
  },
  ...
  getSelectedProductCategories: () => {
    ...
    const categoryMapping: Record<string, ProductCategory> = {
      ...
      "soluble-dietary-fibers": "SOLUBLE_DIETARY_FIBERS",
      "insoluble-dietary-fibers": "INSOLUBLE_DIETARY_FIBERS",
      allergens: "ALLERGENS",
      additives: "ADDITIVES",
      others: "OTHERS",
    };
